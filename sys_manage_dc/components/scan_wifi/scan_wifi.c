...
#endif /* CONFIG_USE_SCAN_CHANNEL_BITMAP */

static const char *TAG = "scan";

/* Hàm in ra kiểu xác thực */
...
void wifi_scan(char ssid_array[][MAX_SSID_LENGTH + 1])
{
    ...
    for (int i = 0; i < number; i++) {
        // Sao chép SSID từ ap_info sang ssid_array
        strncpy(ssid_array[i], (const char *)ap_info[i].ssid, MAX_SSID_LENGTH);
        ssid_array[i][MAX_SSID_LENGTH] = '\0';        
